...
describe('Trying some code', () => {
    test('Test JSON', async () => {
        ...
        }`, testPath('json.png'), await testTheme());

        expect(result.buffer).toBeDefined();
    });

    test('Test CSharp', async () => {
        const result = await highlightScreenshotToPath(`using System.IO.Compression;
        ...
        }`, testPath('csharp.png'), await testTheme());
    ...
    test('Test XML', async () => {
        ...
        `, testPath('xml.png'), await testTheme());
